...
<div class="flex flex-wrap">
  <div class="flex w-full flex-col md:w-1/2">
    <div class="flex justify-center pt-12 md:-mb-2 md:justify-start md:pl-12 ">
  ...
  <div class="pointer-events-none relative hidden h-screen select-none bg-black md:block md:w-1/2">
    ...
    <img class="-z-1 absolute top-0 h-full w-full object-cover opacity-90" src={background} />
  </div>
</div>
);
}
